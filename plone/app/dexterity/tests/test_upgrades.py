...
class TestUpgrades(unittest.TestCase):
    ...
    def test_add_missing_uuids(self):
        ...
        page = createContentInContainer(self.layer['portal'], 'page', checkConstraints=False)
        ...
        b = self.layer['portal'].portal_catalog.unrestrictedSearchResults(portal_type='page')[0]
